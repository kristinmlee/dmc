...
det_FOmegas_neutral = readRDS("det_FOmegas_neutral.killifish.RDS")

inv_FOmegas_neutral = readRDS("inv_FOmegas_neutral.killifish.RDS")
...
times = c(0, 5, seq(10,1000,length=15),seq(1500,3000,length=15), 10e6)
gs = 10^(-(2:10))
...
saveRDS(compLikelihood_neutral, "compLikelihood_neutral.killi.RDS")
