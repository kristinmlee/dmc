...
det_FOmegas_indSweeps_e = readRDS("det_FOmegas_indSweeps_e.mim.RDS")

inv_FOmegas_indSweeps_e = readRDS("inv_FOmegas_indSweeps_e.mim.RDS")
...
saveRDS(compLikelihood_indSweeps, paste("compLikelihood_indSweeps_selSites_", paste(selSiteInterest, collapse = "_"), ".mim.RDS", sep = ""))