...
FOmegas_stdVar= readRDS("FOmegas_stdVar_45.RDS") #pars: sels, gs, std var times
FOmegas_stdVar.source= readRDS("FOmegas_stdVar_source_45.RDS") #pars: sels, gs, times
FOmegas_mig.stagSweeps=readRDS("FOmegas_mig_stagSweeps_45.RDS") # pars: sels, gs, times
FOmegas_mig.concSweeps=readRDS("FOmegas_mig_concSweeps_45.RDS") # pars: sels, migs
...
saveRDS(det_FOmegas_neutral, file="det_FOmegas_neutral_ARNT.RDS")
saveRDS(inv_FOmegas_neutral, file="inv_FOmegas_neutral_ARNT.RDS")
...
saveRDS(det_FOmegas_stdVar, file="det_FOmegas_stdVar_ARNT.RDS")
saveRDS(inv_FOmegas_stdVar, file="inv_FOmegas_stdVar_ARNT.RDS")
...
saveRDS(det_FOmegas_stdVar.source, file="det_FOmegas_stdVar_source_ARNT.RDS")
saveRDS(inv_FOmegas_stdVar.source, file="inv_FOmegas_stdVar_source_ARNT.RDS")
...
saveRDS(det_FOmegas_mig.stagSweeps, file="det_FOmegas_mig_stagSweeps_ARNT.RDS")
saveRDS(inv_FOmegas_mig.stagSweeps, file="inv_FOmegas_mig_stagSweeps_ARNT.RDS")
...
saveRDS(det_FOmegas_mig.concSweeps, file="det_FOmegas_mig_concSweeps_ARNT.RDS")
saveRDS(inv_FOmegas_mig.concSweeps, file="inv_FOmegas_mig_concSweeps_ARNT.RDS")
